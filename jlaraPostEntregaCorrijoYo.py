...
class Inventario(Producto):
    ...
    inventario=[]     # Agregado después de entregar el trabajo, y todos los inventario con self.inventario

    def __init__(self, nombre=None, categoria=None, precio=0, cantidad=0):
    ...
    def agregarProducto(self):
        self.inventario.append(self.get_producto)
    ...
    def buscarProducto(self):
        if self.inventario == []:
            ...
            for self.get_producto in self.inventario:
